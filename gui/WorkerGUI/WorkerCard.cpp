...
WorkerCard::WorkerCard(Business *business, Worker *worker) : Fl_Window(500, 200, "Worker Card"),
    ...
    workerFullname->align(FL_ALIGN_TOP);
    ...
    workerPosition->align(FL_ALIGN_TOP);
    ...
    workerPhoneNumber->align(FL_ALIGN_TOP);
    ...
    businessAddress->align(FL_ALIGN_TOP);
    ...
    businessPhoneNumber->align(FL_ALIGN_TOP);
